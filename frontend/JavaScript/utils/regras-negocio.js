(function () {
    ...
    function validarDatasViagem(dataSaida, dataChegada) {
        if (!dataSaida || !dataChegada) {
            return "Informe as datas de saida e chegada da viagem.";
        }
    ...
    function validarDespesa(dataDespesa, viagem) {
        ...
        if (viagem && viagem.data_saida && !dataMaiorOuIgual(dataDespesa, viagem.data_saida)) {
            return "A data da despesa nao pode ser anterior a data de saida da viagem.";
        }
        if (viagem && viagem.data_chegada && !dataMaiorOuIgual(viagem.data_chegada, dataDespesa)) {
            return "A data da despesa nao pode ser posterior a data de chegada da viagem.";
        }
        return null;
    }
